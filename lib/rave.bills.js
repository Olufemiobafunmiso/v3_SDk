...
const create_bill = require('../services/bills/rave.create-bill.payment')
...
function Bills(RaveBase) {
	...
	this.create_bill = function (data) {
		...
		return create_bill(data, RaveBase);
	...
	// this.recurring = function (data) {

	// 	return get_a_recurring(data, RaveBase);
	...
	this.fetch_bill_Cat = function (data) {

		return bill_cat(data, RaveBase);

	}
	this.fetch_bill_agencies = function (data) {
